...
device_list = ts_api.getComPorts(filter=ts_api.TSS_FIND_ALL)  ## CHANGED - LOOK FOR EVERYTHING
...
if device is not None:
    ...
    while not stop:  ## ADDED LOOP 
        ...
        if led is not None:
            print(led)
        print("==================================================")
        choice = input("Press q and enter to quit or just enter to continue...")  ## ADDED WAY TO STOP LOOP
        if choice == 'q':
            stop = True
